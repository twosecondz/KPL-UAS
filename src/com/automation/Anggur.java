...
public class Anggur extends Base{
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        // Klik kategori Buah
        wait.until(ExpectedConditions.elementToBeClickable(
	            By.xpath("//android.widget.TextView[@text=\"Buah - buahan\"]")))
	            .click();
		
        // Klik buah anggur
		wait.until(ExpectedConditions.elementToBeClickable(
	            By.xpath("//android.widget.TextView[@resource-id=\"com.pbm.hedelsia:id/anggurtomb\"]")))
	            .click();
